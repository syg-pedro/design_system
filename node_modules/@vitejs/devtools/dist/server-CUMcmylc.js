...
import { t as getInternalContext } from "./context-internal-B-KW2Etz.js";
import { n as consumeTempAuthToken } from "./auth-state-Tq_pqO8q.js";
import { t as MARK_INFO } from "./constants-D8TD3-8r.js";
import { dirClientStandalone } from "./dirs.js";
import { n as getPort } from "./dist-mylS4-hg.js";
...
async function createWsServer(options) {
	...
	if (isClientAuthDisabled) logger.DTK0008().log();
...
//#endregion
export { createDevToolsMiddleware as t };
